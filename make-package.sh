...
basedir="pkgroot/Library/Application Support/org.pqrs/Karabiner-Elements/Applications"
...
cp -R "src/core/grabber/build_xcode/build/Release/karabiner_grabber.app" "$basedir"
cp -R "src/core/observer/build_xcode/build/Release/karabiner_observer.app" "$basedir"
